...
void FVM_TVD_IMPLICIT::calc_F(double* F, CellFluidDynamicsProps cfdp)
{
	F[0] = cfdp.ru;
...
void FVM_TVD_IMPLICIT::calc_G(double* G, CellFluidDynamicsProps cfdp)
{
	G[0] = cfdp.rv;
...
void FVM_TVD_IMPLICIT::calc_H(double* H, CellFluidDynamicsProps cfdp)
{
	H[0] = cfdp.rw;
...
void FVM_TVD_IMPLICIT::flux_Lax_Friedrichs(double* Flux, double* F1, CellFluidDynamicsProps cfdp1, double* F2, CellFluidDynamicsProps cfdp2, Point n)
{
...
void FVM_TVD_IMPLICIT::eigen_values(double* eigen_val, double u, double v, double w, double c, Point n)
{
...
void FVM_TVD_IMPLICIT::left_eigen_vecs(double** left_eigen_vecs, double u, double v, double w, double c, double gamma, Point n)
{
	double g_1 = gamma - 1;
...
void FVM_TVD_IMPLICIT::right_eigen_vecs(double** right_eigen_vecs, double u, double v, double w, double c, double H, Point n)
{
